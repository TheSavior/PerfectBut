            ...
            <div class="posttext">
                ...
                <div class="ratings">
                    <span class="voteOption upvote" id="<?php echo $post->id?>_up">
                        <span class="votecount" id="<?php echo $post->id?>_upcount">(<?php echo $post->upvote?>)</span>
                    ...
                    <span class="voteOption downvote" id="<?php echo $post->id?>_down">
                        <span class="votecount" id="<?php echo $post->id?>_downcount">(<?php echo $post->downvote?>)</span>
